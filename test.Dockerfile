...
RUN git clone --recursive --depth=1 https://github.com/khs1994-php/is.git /root/khs1994-php/is \
    && cd /root/khs1994-php/is \
    && composer install -q \
    && composer update -q \
    && vendor/bin/phpunit
...
COPY --from=0 /root/khs1994-php/is /root/khs1994-php/is

RUN cd /root/khs1994-php/is \
